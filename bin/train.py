...
if __name__ == "__main__":
    ...
    try:
        # img
        data = '{"runType":"train","dataInfo":{"purposeType":"classification","classInfo":[{"classId":"c87f5","className":"Fog","color":"#cad274","desc":"","dsId":"e3375","dsName":"[CLF] LG\uc5d4\uc194_Train_dataset","isClick":false,"showTf":true,"sourceClassId":"336ba","sourceClassName":"cat"},{"classId":"c87f1","className":"No-fog","color":"#cad244","desc":"","dsId":"e337e","dsName":"[CLF] LG\uc5d4\uc194_Train_dataset","isClick":false,"showTf":true,"sourceClassId":"336aa","sourceClassName":"dog"}],"mlType":"vision","sourceType":"file"},"servInfo":{"servIp":"string","servPort":"string","sendResultUrl":"string","sendStatusUrl":"string"},"pathInfo":{"trainPathList":["/data/sungmin/fog_path/sample/brd"],"modelPath":"/data/sungmin/test_orgfocal","weightPath":"/data/sungmin/test_orgfocal/weight","logPath":"/data/sungmin/test_orgfocal/log.log","pvPath":"/data/sungmin/test_orgfocal"},"selectedHyperParam":{"epoch":100,"batchSize":16,"trainRate":{"train":70,"validation":30},"grayScale":"false","optimizer":"adam","learningRate":0.0001,"earlyStopping":"true","patience":10,"monitor":"loss","gpuIdx":"auto"},"useClassBalancer":false}'
